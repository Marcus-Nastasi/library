...
public class RentBeans {
    ...
    @Bean
    public RentUseCase rentUseCase(RentGateway rentGateway, BookUseCase bookUseCase, MemberUseCase memberUseCase) {
        return new RentUseCase(rentGateway, bookUseCase, memberUseCase);
    }

...
public class Book implements Serializable {
    ...
    public Book updateDetails(Book updatedBook) {
        if (updatedBook.price < 0) throw new DomainException("Price cannot be negative");
        if (updatedBook.quantity < 0) throw new DomainException("Quantity cannot be negative");
